...
perl break.pl < data/output/recs.txt | db_load -T -t hash data/output/re.idx
perl break.pl < data/output/terms.txt | db_load -T -c dupsort=1 -t btree data/output/te.idx
perl break.pl < data/output/emails.txt | db_load -T -c dupsort=1 -t btree data/output/em.idx
perl break.pl < data/output/dates.txt | db_load -T -c dupsort=1 -t btree data/output/da.idx
